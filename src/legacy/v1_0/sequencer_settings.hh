...
public:
	...
	Catalyst2::Legacy::V1_0::Channel::Cv::Range range;
	Catalyst2::Legacy::V1_0::Channel::Mode mode;
...
public:
	...
	Catalyst2::Legacy::V1_0::Channel::Cv::Range GetRange(uint8_t chan) const {
		return channel[chan].range;
	}
	Clock::Divider::type GetClockDiv(uint8_t chan) {
		return phaser.cdiv[chan];
	}
	Catalyst2::Legacy::V1_0::Channel::Mode GetChannelMode(uint8_t chan) const {
	...
	void SetChannelMode(uint8_t chan, Catalyst2::Legacy::V1_0::Channel::Mode mode) {
