...
// but we can't just use src/ui.hh in the test project because things like #include "output.hh" loads src/outputs.hh, not tests/outputs.hh
// FIXME: figure out how to make test project build system prefer tests/FILE.hh instead of ./FILE.hh when seeing #include "FILE.hh"
